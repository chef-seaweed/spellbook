...
(
    ...
    SELECT
        ...
        ,t.evt_index
    FROM
        {{ source('pancakeswap_v3_zksync', 'PancakeV3Pool_evt_Swap') }} t
    INNER JOIN 
        {{ source('pancakeswap_v3_zksync', 'PancakeV3Factory_evt_PoolCreated') }} f
